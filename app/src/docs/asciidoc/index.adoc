...
include::{snippets}/login-wrong-email/http-request.adoc[]

include::{snippets}/login-wrong-email/http-response.adoc[]

패스워드를 잘못 입력한 경우 BAD REQUEST 응답합니다.

include::{snippets}/login-wrong-password/http-request.adoc[]
