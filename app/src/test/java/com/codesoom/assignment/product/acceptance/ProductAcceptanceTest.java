...
class ProductAcceptanceTest extends AcceptanceTest {
    ...
    void create_product() {
        ...
        TokenResponseData tokenResponseData = 로그인_되어_있음(EMAIL, PASSWORD);

        ExtractableResponse<Response> response = 상품을_생성(tokenResponseData, PRODUCT_NAME, MAKER, IMAGE_URL, PRICE);
