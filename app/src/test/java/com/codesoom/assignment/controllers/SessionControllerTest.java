    ...
    class Describe_createToken {
        ...
        class Context_WithExistedUser {
            ...
            void itCreatesTokenAndReturnsTokenAndCREATEDHttpStatus() throws Exception {
                given(authenticationService.createToken(any(SessionCreateData.class))).willReturn(sessionResultData);
        ...
        class Context_WithNotExistedUser {
            ...
            void itThrowsBadRequestExceptionAndReturnsBAD_REQUESTHttpStatus() throws Exception {
                given(authenticationService.createToken(any(SessionCreateData.class)))
                ...
                verify(authenticationService).createToken(any(SessionCreateData.class));
            }
        }
    }
}
