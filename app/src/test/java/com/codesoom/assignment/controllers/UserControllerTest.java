...
class UserControllerTest {
    ...
    void registerUserWithInvalidAttributes() throws Exception {
        mockMvc.perform(
                ...
                .andDo(document("register-user-invalid"));
    }
    ...
    void updateUserWithInvalidAttributes() throws Exception {
        mockMvc.perform(
                ...
                .andExpect(status().isBadRequest())
                .andDo(document("update-user-invalid"));
    }
    ...
    void updateUserWithNotExistedId() throws Exception {
        mockMvc.perform(
                ...
                .andDo(document("update-user-not-existed"));
    ...
    void updateUserWithoutAccessToken() throws Exception {
        mockMvc.perform(
                ...
                .andDo(document("update-user-without-accessToken"));
    }
    ...
    void updateUserWithOthersAccessToken() throws Exception {
        mockMvc.perform(
                ...
                .andDo(document("update-user-with-other-accessToken"));
    ...
    void destroyWithNotExistedId() throws Exception {
        mockMvc.perform(
                ...
                .andExpect(status().isNotFound())
                .andDo(document("delete-user-not-existed"));
