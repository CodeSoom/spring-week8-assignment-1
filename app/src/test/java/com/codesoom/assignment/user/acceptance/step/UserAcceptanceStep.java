...
public class UserAcceptanceStep extends AcceptanceTest {
    ...
    public static TokenResponseData 로그인_되어_있음(String email, String password) {
        ExtractableResponse<Response> response = 로그인_요청(email, password);

        TokenResponseData tokenResponseData = response.as(TokenResponseData.class);
    ...
    public static void 로그인_됨(ExtractableResponse<Response> response) {
        ...
        assertThat(tokenResponseData.getAccessToken()).isNotBlank();
    }
}
