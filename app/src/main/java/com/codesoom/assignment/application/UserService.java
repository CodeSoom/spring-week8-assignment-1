...
public class UserService {
    ...
    /**
     * 주어진 id의 회원정보를 새로운 정보로 수정하고, 수정된 회원정보를 리턴합니다.
     * @param id 수정 대상 회원의 식별자
     * @param modificationData 새로운 정보
     * @param userId 수정 요청을 보내는 회원의 식별자
     * @return 수정된 회원정보
     * @throws AccessDeniedException 요청하는 회원에게 권한이 없는 경우
     */
