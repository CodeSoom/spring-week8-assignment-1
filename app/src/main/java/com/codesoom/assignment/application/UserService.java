...
public class UserService {
    ...
    /**
     * 새로운 회원을 등록하고, 등록된 회원을 리턴합니다.
     *
     * @param registrationData 새로 등록하려는 회원 정보
     * @return 등록된 회원 정보
     */
    ...
    /**
     * 회원 목록 중 id의 회원을 찾아 회원 정보를 수정하여 리턴합니다.
     *
     * @param id 회원 id
     * @param modificationData 수정하려는 회원 정보
